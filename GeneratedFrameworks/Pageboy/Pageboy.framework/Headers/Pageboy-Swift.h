...
#ifndef PAGEBOY_SWIFT_H
#define PAGEBOY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Pageboy",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Pageboy21PageboyViewController")
@interface PageboyViewController : UIViewController
...
@interface PageboyViewController (SWIFT_EXTENSION(Pageboy)) <UIScrollViewDelegate>
